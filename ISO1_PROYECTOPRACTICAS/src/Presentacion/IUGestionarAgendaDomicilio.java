...
public class IUGestionarAgendaDomicilio extends JFrame  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IUGestionarAgendaDomicilio frame = new IUGestionarAgendaDomicilio();
	 ...
	 * @throws SQLException 
	 */
	public IUGestionarAgendaDomicilio() throws SQLException {
